...
class DataParallelExecutorGroup(object):
    ...
    def bind_exec(self, data_shapes, label_shapes, shared_group=None, reshape=False, partial_shaping=False, allow_up_sizing=False):
        ...
        for i in range(len(self.contexts)):
            ...
            if reshape:
                self.execs[i] = self._default_execs[i].reshape(partial_shaping=partial_shaping,
    ...
    def reshape(self, data_shapes, label_shapes, partial_shaping=False, allow_up_sizing=False):
        """Reshape executors.
        ...
        self.bind_exec(data_shapes, label_shapes, reshape=True, partial_shaping=False, allow_up_sizing=False)
